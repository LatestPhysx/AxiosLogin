...
The access token returned by the DummyJSON login endpoint is stored in localStorage and removed during logout. Logging out simply consists of deleting the stored token Part in DevTools.
